...
function FaseSidebar({ fase, start }: {
        ...
        <div className="mb-12">
          ...
          <div className="flex">
            {FASES.map((f) => (
              <div
                key={f.nr}
                className={`border border-r-0 last:border-r border-ink/20 px-2 pt-1.5 pb-2 ${
                  "accent" in f && f.accent ? "bg-terracotta text-paper" : "bg-paper text-ink"
                }`}
