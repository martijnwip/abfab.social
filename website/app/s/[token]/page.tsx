...
export default async function SharedScenarioPage({ params }: { params: Promise<{ token: string }> }) {
  ...
  // Token ophalen + geldigheid controleren
  ...
  return (
    <div className="bg-paper min-h-screen">
      {/* Publieke banner */}
      <div className="bg-krant/40 border-b border-ink/10 px-8 py-2.5 flex items-center justify-between">
